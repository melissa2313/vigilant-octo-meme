...
function UILib.CreateWindow(libName, version, logoId)
    ...
    key1.TextColor3 = Color3.fromRGB(255, 0, 0)
    ...
    hubLogo.ZIndex = 2
    hubLogo.Image = "https://static.wikia.nocookie.net/pet-simulator/images/c/cd/Huge_Hacked_Cat_PSX.png/revision/latest?cb=20220123075226"
    ...
    usename.TextColor3 = Color3.fromRGB(255, 96, 59)
    ...
    wave.ImageColor3 = Color3.fromRGB(255, 0, 0)
    ...
    function TabHandling:Tab(tabText, tabId)
        ...
        tabBtn.BackgroundColor3 = Color3.fromRGB(255, 173, 166)
        ...
        tabLogo.ImageColor3 = Color3.fromRGB(255, 0, 0)
        --
                        ...
                        for i, v in next, v:GetChildren() do
                            if v:IsA("TextButton") then
                                game.TweenService:Create(
                                    ...
                                    {
                                        TextColor3 = Color3.fromRGB(255, 81, 13)
                                    }
                                ):Play()
                            end
                            if v:IsA("ImageLabel") then
                                game.TweenService:Create(
                                    ...
                                    TweenInfo.new(0.18, Enum.EasingStyle.Quint, Enum.EasingDirection.In),
                                    {
                                        ImageColor3 = Color3.fromRGB(255, 81, 13)
                                    }
                                ):Play()
                            end
                        end
        ...
        function sectionHandling:Section(sectionText)
            ...
            sectionName.TextColor3 = Color3.fromRGB(255, 0, 0)
            ...
            sectionExpannd.ImageColor3 = Color3.fromRGB(255, 0, 0)
                    ...
                    function()
                        if not debounce1 then
                            ...
                            game.TweenService:Create(
                                ...
                                TweenInfo.new(0.18, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
                                {
                                    BackgroundColor3 = Color3.fromRGB(168, 101, 112),
            ...
            function ItemHandling:Toggle(toggInfo, enabledByDefault, callback)
                ...
                if enabledByDefault then
                    checkBtn.Parent.toggleInfo.TextColor3 = Color3.fromRGB(255, 0, 0)
                    checkBtn.ImageColor3 = Color3.fromRGB(255, 0, 0)
            ...
            function ItemHandling:KeyBind(keyInfo, first, callback)
                ...
                key.Text = oldKey
                key.TextColor3 = Color3.fromRGB(255, 0, 0)
                key.TextSize = 14.000
            ...
            function ItemHandling:Slider(slidInfo, minvalue, maxvalue, callback)
                ...
                dragSlider.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
            ...
            function ItemHandling:DropDown(dropInfo, list, callback)
                ...
                expand_more.ImageColor3 = Color3.fromRGB(255, 0, 0)
                ...
                dropdownItem1.TextColor3 = Color3.fromRGB(255, 0, 0)
                ...
                for i, v in next, list do
                    ...
                    optionBtn1.Text = "  " .. v
                    optionBtn1.TextColor3 = Color3.fromRGB(200, 120, 133)
                    ...
                    optionBtn1.MouseLeave:Connect(
                        function()
                            game.TweenService:Create(
                                ...
                                {
                                    BackgroundColor3 = Color3.fromRGB(21, 21, 21),
                                    TextColor3 = Color3.fromRGB(209, 35, 0)
                                }
                            ):Play()
                        end
                    )
